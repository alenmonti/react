    ...
    return (
        <div className="w-full bg-white flex flex-col text-center">
            <div className="flex justify-center items-center relative max-w-[1200px] mx-auto">
                ...
                <div className="h-[65px] border-l-[1px] border-gray-300"></div>
                <div className="flex flex-col max-w-[400px] p-[35px]">
                ...
                <div className="h-[65px] border-l-[1px] border-gray-300 inline-block"></div>
                <div className="flex flex-col max-w-[400px] p-[35px]">
            ...
            <div className="w-full flex justify-center">
                <div className="flex justify-between w-[1200px] text-center">
                    <div className="flex flex-col rounded-md border-gray-300 w-full max-w-[47%] border-[1px] py-4 gap-1 justify-center">
                    ...
                    <div className="flex flex-col rounded-md border-gray-300 border-[1px] w-full max-w-[47%] py-4 gap-1 justify-center">
            ...
            <div className="w-full pt-4 border-t-[1px] border-gray-300 mt-20">
                <div className="max-w-[1200px] mx-auto">
                    <div className="flex justify-between items-center gap-4 flex-wrap text-xs cursor-pointer">
